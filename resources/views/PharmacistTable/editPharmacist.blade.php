...
@section('content')
    <div class="container">
        ...
        <br/>
        <form action='/editPharmacist/{{$pharmacist->id}}/updatePharmacist' method='POST'>
            @csrf
            <div class="form-group {{ $errors->has('pharmacist_firstname') ? 'has-error' : '' }}">
                ...
                <input type='text' name='pharmacist_firstname' class="form-control" id="pharmacist_firstname" value="{{$pharmacist->pharmacist_firstname}}"/>
            ...
            <div class="form-group {{ $errors->has('pharmacist_lastname') ? 'has-error' : '' }}">
                ...
                <input type='text' name='pharmacist_lastname' class="form-control" id="pharmacist_lastname" value="{{$pharmacist->pharmacist_lastname}}"/>
            ...
            <div class="form-group {{ $errors->has('pharmacist_email') ? 'has-error' : '' }}">
                ...
                <input type='text' name='pharmacist_email' class="form-control" id="pharmacist_email" value="{{$pharmacist->pharmacist_email}}"/>
            ...
            <div class="form-group {{ $errors->has('pharmacist_salary') ? 'has-error' : '' }}">
                ...
                <input type='number' name='pharmacist_salary' class="form-control" id="pharmacist_salary" value="{{$pharmacist->pharmacist_salary}}"/>
            ...
            <div class="form-group {{ $errors->has('pharmacist_startjob') ? 'has-error' : '' }}">
                ...
                <input type='date' name='pharmacist_startjob' class="form-control" id="pharmacist_startjob" value="{{$pharmacist->pharmacist_startjob}}"/>
            ...
            <div class="form-group {{ $errors->has('pharmacist_city') ? 'has-error' : '' }}">
                ...
                <input type='text' name='pharmacist_city' class="form-control" id="pharmacist_city" value="{{$pharmacist->pharmacist_city}}"/>
            ...
            <div class="form-group {{ $errors->has('pharmacist_street') ? 'has-error' : '' }}">
                ...
                <input type='text' name='pharmacist_street' class="form-control" id="pharmacist_street" value="{{$pharmacist->pharmacist_street}}"/>
            ...
            <div class="form-group {{ $errors->has('pharmacist_phone') ? 'has-error' : '' }}">
                ...
                <input type='text' name='pharmacist_phone' class="form-control" id="pharmacist_phone" value="{{$pharmacist->pharmacist_phone}}"/>
